package pratikthapa.example.com.nepstrademo.Pojo;
...
public class ProductObject implements Serializable {
    ...
    public ProductObject(Integer id, Integer count, Integer menu_order, Integer parent, Integer image_id, String name, String slug, String description, String display , String date_created, String date_created_gmt, String date_modified, String date_modified_gmt, String src, String title, String alt, String self_href, String collection_href) {
        this.id = id;
        this.count = count;
